...
module.exports.register = asyncHandler((req, res) =>
...
module.exports.users = asyncHandler((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
...
module.exports.user = asyncHandler((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const { user } = req.params;
    try {
      const singleUser = yield User.findById(
        new mongoose_1.default.Types.ObjectId(user)
      ).select("-password");
...
module.exports.setAvatar = asyncHandler((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const { _id: auth } = res.locals.user;
...
module.exports.deleteUser = asyncHandler((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const { _id: auth } = res.locals.user;
    try {
